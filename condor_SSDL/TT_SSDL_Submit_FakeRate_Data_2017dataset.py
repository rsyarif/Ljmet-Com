...
logdir = 'LJMet94x_2lepTT_2017datasets_FakeRate_'+date+'_rizki'
# logdir = 'LJMet94x_2lepTT_2017datasets_FakeRate_'+date+'_rizki_TESTDELETEME'
...
#     locdir = logdir+'/'+prefix[i]
    ...
    while ( nfiles <= count ):
        ...
        for line in producer_templ_file:
            ...
            line=line.replace('CONDOR_ISMC', str('False'))
        ...
        py_templ_file = open(rel_base+'/src/LJMet/Com/condor_SSDL/Dilepton_Data2017_templ.py')
